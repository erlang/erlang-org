...
compatible TAR program.
    ...
    $ tar -zxf otp_src_29.1.tar.gz    # Assuming bash/sh

or clone from github:

    $ git clone https://github.com/erlang/otp otp_src_29.1
...
`/opt/erlang/29.1/{bin,lib/erlang}`, use the `--prefix=/opt/erlang/29.1` option.
...
When building the documentation you need a full Erlang/OTP-29.1 system in
the `$PATH`.
...
[html documentation]: https://github.com/erlang/otp/releases/download/OTP-29.1/otp_doc_html_29.1.tar.gz
[the released source tar ball]: https://github.com/erlang/otp/releases/download/OTP-29.1/otp_src_29.1.tar.gz
