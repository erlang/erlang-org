...
SCRIPT_FILES="_scripts/download-docs.sh _scripts/otp_flatten_docs _scripts/otp_flatten_ex_docs _scripts/otp_doc_sitemap.sh docs/LATEST_MAJOR_VSN _scripts/otp_add_headers.sh"
...
_get_doc_hash() {
    # _scripts/_get_doc_hash.sh ${OTP_VERSIONS_TABLE} "$1"
...
LATEST_MAJOR_VSN=$(cat "docs/LATEST_MAJOR_VSN")
RINCLUDE=()
