...
*   `ex_doc` -- [ExDoc](https://hexdocs.pm/ex_doc/readme.html) is a tool to
    ...
    ExDoc v0.40.1 was used to build the documentation for this release,
...
compatible TAR program.
    ...
    $ tar -zxf otp_src_28.5.0.3.tar.gz    # Assuming bash/sh

or clone from github:

    $ git clone https://github.com/erlang/otp otp_src_28.5.0.3
...
`/opt/erlang/28.5.0.3/{bin,lib/erlang}`, use the `--prefix=/opt/erlang/28.5.0.3` option.
...
When building the documentation you need a full Erlang/OTP-28.5.0.3 system in
the `$PATH`.

    $ export PATH=$ERL_TOP/bin:$PATH     # Assuming bash/sh

To build `html` and `epub` docs you need to have [ExDoc v0.40.1](https://github.com/elixir-lang/ex_doc).
...
Extract the html archive in the installation directory.
    ...
    $ cd <ReleaseDir>
    $ tar -zxf otp_html_28.5.0.3.tar.gz
...
[html documentation]: https://github.com/erlang/otp/releases/download/OTP-28.5.0.3/otp_doc_html_28.5.0.3.tar.gz
[the released source tar ball]: https://github.com/erlang/otp/releases/download/OTP-28.5.0.3/otp_src_28.5.0.3.tar.gz
