...
compatible TAR program.
    ...
    $ tar -zxf otp_src_28.5.0.6.tar.gz    # Assuming bash/sh

or clone from github:

    $ git clone https://github.com/erlang/otp otp_src_28.5.0.6
...
`/opt/erlang/28.5.0.6/{bin,lib/erlang}`, use the `--prefix=/opt/erlang/28.5.0.6` option.
...
When building the documentation you need a full Erlang/OTP-28.5.0.6 system in
the `$PATH`.
...
Extract the html archive in the installation directory.
    ...
    $ cd <ReleaseDir>
    $ tar -zxf otp_html_28.5.0.6.tar.gz
...
[html documentation]: https://github.com/erlang/otp/releases/download/OTP-28.5.0.6/otp_doc_html_28.5.0.6.tar.gz
[the released source tar ball]: https://github.com/erlang/otp/releases/download/OTP-28.5.0.6/otp_src_28.5.0.6.tar.gz
