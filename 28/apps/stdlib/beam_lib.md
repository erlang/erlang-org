# `beam_lib`
[🔗](https://github.com/erlang/otp/blob/OTP-28.5.0.7/lib/stdlib/src/beam_lib.erl#L22)
...
```elixir
-type chnk_rsn() ::
          {unknown_chunk, beam(), atom()} |
          {key_missing_or_invalid, beam(), abstract_code | debug_info} |
...
-type info_rsn() ::
          ...
          {invalid_beam_file, beam(), Position :: non_neg_integer()} |
