# `ms_transform`
[🔗](https://github.com/erlang/otp/blob/OTP-28.5.0.3/lib/stdlib/src/ms_transform.erl#L22)
...
```elixir
-spec parse_transform(Forms, Options) -> Forms2 | Errors | Warnings
                         when
...
```elixir
-spec transform_from_shell(Dialect, Clauses, BoundEnvironment) -> term()
                              when
                                  Dialect :: ets | dbg,
