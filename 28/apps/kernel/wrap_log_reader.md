# `wrap_log_reader`
[🔗](https://github.com/erlang/otp/blob/OTP-28.5.0.3/lib/kernel/src/wrap_log_reader.erl#L25)
...
```elixir
-opaque continuation() ::
            #wrap_reader{fd :: file:fd(),
                         cont :: dlog_cont(),
                         file :: file:filename(),
                         file_no :: non_neg_integer(),
                         mod_time :: file:date_time(),
                         first_no :: non_neg_integer() | one}.
```
