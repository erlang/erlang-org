...
[🔗](https://github.com/erlang/otp/blob/OTP-28.5.0.7/lib/ssl/src/ssl_session_cache_api.erl#L25)
...
```elixir
-callback size(CacheRef) -> Size when CacheRef :: session_cache_ref(), Size :: non_neg_integer().
```
