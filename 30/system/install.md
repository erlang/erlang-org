...
*   `ex_doc` -- [ExDoc](https://hexdocs.pm/ex_doc/readme.html) is a tool to
    ...
    ExDoc v0.40.4 was used to build the documentation for this release,
...
To build `html` and `epub` docs you need to have [ExDoc v0.40.4](https://github.com/elixir-lang/ex_doc).
