...
This document describes how to build and install Erlang/OTP-30.
...
*   `ex_doc` -- [ExDoc](https://hexdocs.pm/ex_doc/readme.html) is a tool to
    ...
    ExDoc v0.40.3 was used to build the documentation for this release,
...
compatible TAR program.
    ...
    $ tar -zxf otp_src_30.0-rc0.tar.gz    # Assuming bash/sh

or clone from github:

    $ git clone https://github.com/erlang/otp otp_src_30.0-rc0
...
`/opt/erlang/30.0-rc0/{bin,lib/erlang}`, use the `--prefix=/opt/erlang/30.0-rc0` option.
...
When building the documentation you need a full Erlang/OTP-30.0-rc0 system in
the `$PATH`.

    $ export PATH=$ERL_TOP/bin:$PATH     # Assuming bash/sh

To build `html` and `epub` docs you need to have [ExDoc v0.40.3](https://github.com/elixir-lang/ex_doc).
...
Extract the html archive in the installation directory.
    ...
    $ cd <ReleaseDir>
    $ tar -zxf otp_html_30.0-rc0.tar.gz
...
[html documentation]: https://github.com/erlang/otp/releases/download/OTP-30.0-rc0/otp_doc_html_30.0-rc0.tar.gz
[the released source tar ball]: https://github.com/erlang/otp/releases/download/OTP-30.0-rc0/otp_src_30.0-rc0.tar.gz
