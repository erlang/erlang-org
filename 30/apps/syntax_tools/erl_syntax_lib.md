# `erl_syntax_lib`
[🔗](https://github.com/erlang/otp/blob/master/lib/syntax_tools/src/erl_syntax_lib.erl#L33)
...
```erlang
-type key() ::
          attributes | errors | exports | functions | imports | module | module_imports | records |
          warnings.
```
