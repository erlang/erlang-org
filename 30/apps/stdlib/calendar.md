...
```erlang
-spec local_time_to_system_time(LocalTime :: datetime1970(), Options) -> non_neg_integer()
...
```erlang
-spec valid_date(Date) -> boolean()
                    when Date :: {Year :: integer(), Month :: integer(), Day :: integer()}.
```
