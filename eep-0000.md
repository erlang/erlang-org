...
<TD align='left'>Implemented in OTP version 27.0;        the regular expression sigils (<code>~r</code> and <code>~R</code>) are not implemented</TD>
</TR>
<TR>
...
<pre><code>File eep-0018.md: 'status: Replaced' illegal!
File eep-0059.md: 'status:' tag Implemented in OTP version 27.0 ne Implemented in OTP version 27.0;        the regular expression sigils (`~r` and `~R`) are not implemented!
File eep-0068.md: 'status:' tag Implemented in OTP release 27.0 ne Implemented in OTP version 27.0;        the regular expression sigils (`~r` and `~R`) are not implemented!
