...
layout: post
id: 186
title: "Erlang/OTP 29.0 Release Candidate 3"
lead: "Erlang/OTP 29.0-rc3 is the third release candidate for OTP 29"
tags: "release, OTP, 29.0-rc3, Release Candidate"
date: "2026-04-15"
author: "Björn Gustavsson"
---
## OTP 29.0-rc3

Erlang/OTP 29.0-rc3 is the third and final release candidate before
the OTP 29.0 release.
...
[Erlang/OTP Github](https://github.com/erlang/otp/releases/tag/OTP-29.0-rc3) release
and you can view the new documentation at
[https://erlang.org/documentation/doc-17.0-rc3/doc](https://erlang.org/documentation/doc-17.0-rc3/doc/).
You can also install the latest release using [kerl](https://github.com/kerl/kerl) like this:

```
kerl build 29.0-rc3 29.0-rc3.
```
...
For more details about new features and potential incompatibilities see the [README](https://erlang.org/download/otp_src_29.0-rc3.readme).
