...
</download/otp_src_19.1.readme>

You can download the full source distribution from </download/otp_src_19.1.tar.gz>
...
</download/otp_win32_19.1.exe>

</download/otp_win64_19.1.exe>

You can also download the complete HTML documentation or the Unix manual files

</download/otp_doc_html_19.1.tar.gz>
</download/otp_doc_man_19.1.tar.gz>
