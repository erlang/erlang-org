# `gl`
[🔗](https://github.com/erlang/otp/blob/OTP-29.1.1/lib/wx/src/gen/gl.erl#L28)
...
```erlang
-spec dispatchComputeGroupSizeARB(Num_groups_x, Num_groups_y, Num_groups_z, Group_size_x, Group_size_y,
                                  Group_size_z) ->
                                     ok
                                     when
                                         Num_groups_x :: i(),
...
```erlang
-spec getActiveAttribARB(ProgramObj :: i(), Index :: i(), MaxLength :: i()) ->
                            {Size :: i(), Type :: enum(), Name :: string()}.
```
...
```erlang
-spec getActiveUniformARB(ProgramObj :: i(), Index :: i(), MaxLength :: i()) ->
                             {Size :: i(), Type :: enum(), Name :: string()}.
```
...
```erlang
-spec getImageHandleARB(Texture :: i(), Level :: i(), Layered :: 0 | 1, Layer :: i(), Format :: enum()) ->
                           i().
```
...
```erlang
-spec getUniformi64vARB(Program :: i(), Location :: i()) ->
                           {i(),
                            i(),
                            i(),
                            i(),
...
```erlang
-spec getUniformivARB(ProgramObj :: i(), Location :: i()) ->
                         {i(),
                          i(),
                          i(),
                          i(),
...
```erlang
-spec getUniformui64vARB(Program :: i(), Location :: i()) ->
                            {i(),
                             i(),
                             i(),
                             i(),
...
```erlang
-spec programEnvParameter4dARB(Target :: enum(), Index :: i(), X :: f(), Y :: f(), Z :: f(), W :: f()) ->
                                  ok.
```
...
```erlang
-spec programEnvParameter4fARB(Target :: enum(), Index :: i(), X :: f(), Y :: f(), Z :: f(), W :: f()) ->
                                  ok.
```
...
```erlang
-spec programLocalParameter4dARB(Target :: enum(), Index :: i(), X :: f(), Y :: f(), Z :: f(), W :: f()) ->
                                    ok.
```
...
```erlang
-spec programLocalParameter4fARB(Target :: enum(), Index :: i(), X :: f(), Y :: f(), Z :: f(), W :: f()) ->
                                    ok.
```
...
```erlang
-spec programUniform4i64ARB(Program :: i(), Location :: i(), X :: i(), Y :: i(), Z :: i(), W :: i()) ->
                               ok.
```
...
```erlang
-spec programUniform4ui64ARB(Program :: i(), Location :: i(), X :: i(), Y :: i(), Z :: i(), W :: i()) ->
                                ok.
```
