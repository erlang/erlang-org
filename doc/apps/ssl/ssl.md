# `ssl`
[🔗](https://github.com/erlang/otp/blob/OTP-29.1.1/lib/ssl/src/ssl.erl#L28)
...
```erlang
-type kex_algo() :: ecdhe_ecdsa | ecdh_ecdsa | ecdh_rsa | any | legacy_kex().
```
...
```erlang
-type srp_param_type() :: srp_8192 | srp_6144 | srp_4096 | srp_3072 | srp_2048.
```
...
```erlang
-type legacy_kex() ::
          rsa | rsa_psk | dhe_rsa | dhe_dss | srp_rsa | srp_dss | dhe_psk | psk | ecdh_anon | dh_anon |
          srp_anon.
```
...
-type connection_info_keys() ::
          [protocol | selected_cipher_suite | selected_group | sni_hostname | session_resumption |
           ciphers | client_random | server_random | master_secret | keylog | session_id |
           session_data | ecc | srp_username].
```
